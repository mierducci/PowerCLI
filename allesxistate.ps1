...
#----------------------------------------------------------[Declarations]----------------------------------------------------------
$Vcenters =  'inv1503.nxdi.nl-cdc01.nxp.com', 'inv0885.nxdi.nl-cdc01.nxp.com'

#$Vcenter = 'inv0885.nxdi.nl-cdc01.nxp.com'
$User = 'srv_ansible_vmware@wbi.nxp.com'
$Pass = 'GFGFmIQff7!Y\Kq'

#Comnented user typed inputs
#$User = ''
...
foreach ($Vcenter in $Vcenters) {
    ...
    foreach ($HostVMwareNXP in $HostsVMwareNXP) {
         ...
         if ($Vcenter -eq 'inv1503.nxdi.nl-cdc01.nxp.com'){
            $pswd = 'NXPrnDNxDi1!@#'
         } if ($Vcenter -eq 'inv0885.nxdi.nl-cdc01.nxp.com'){
            $pswd='NXPrnDOra885!@#'
    ...
    | sort-object -property ComputeClusterName | Export-Csv $Vcenter"-VMWARE".csv -UseCulture -NoTypeInformation
